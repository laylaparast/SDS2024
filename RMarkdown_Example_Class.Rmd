...
Pick another variable from this dataset and investigate if the number of days to adoption is related to it or not. I will pick the variable Condition which is equal to Normal, Injured, or Sick. The code below pulls from code used in previous classes.
...
Include a picture of a cute cat or dog. You must have the file of the photo you are using in the same folder as this markdown. Look at this cute dog:
